...
#ifndef QMOBILEDATASTORE_SWIFT_H
#define QMOBILEDATASTORE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="QMobileDataStore",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif



SWIFT_CLASS("_TtC16QMobileDataStore13CoreDataStore")
...
@interface NSManagedObject (SWIFT_EXTENSION(QMobileDataStore))
...
SWIFT_CLASS("_TtC16QMobileDataStore6Record")
...
- (NSDictionary<NSString *, id> * _Nonnull)dictionaryWithValuesForKeys:(NSArray<NSString *> * _Nonnull)keys SWIFT_WARN_UNUSED_RESULT;
